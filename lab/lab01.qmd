...
![Set working directory in VS Code Server](/images/working_directory_vs_code.png){alt="Set working directory in VS Code Server"}
...
![Anaconda vs. Miniconda](/images/anaconda_vs_miniconda.png){alt="Anaconda vs. Miniconda"}
...
![Installing Full Distribution of Anaconda](/images/installing_anaconda.png){alt="Installing Full Distribution of Anaconda"}
